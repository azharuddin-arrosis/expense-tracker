...
export const EXPENSE_CATEGORIES: Category[] = [
  ...
  { id: 'sekolah', name: 'Sekolah', color: '#6366F1' },
  { id: 'cicilan', name: 'Cicilan', color: '#F97316' },
  { id: 'rumah', name: 'Rumah', color: '#14B8A6' },
  { id: 'pakaian', name: 'Pakaian', color: '#E879F9' },
  { id: 'pulsa', name: 'Pulsa/Internet', color: '#0EA5E9' },
  { id: 'asuransi', name: 'Asuransi', color: '#64748B' },
  { id: 'kesehatan', name: 'Kesehatan', color: '#EC4899' },
  { id: 'bayi', name: 'Bayi/Anak', color: '#FB7185' },
